...
namespace AI
{
    ...
    public class AIMovementFrogs : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                _animationController.SetBool("TurnRight", true);
                transform.Rotate(transform.up * Time.deltaTime * _rotationSpeed);
                _animationController.SetBool("TurnRight", false);
            }

            if (_isRotatingLeft == true)
            {
                _animationController.SetBool("TurnLeft", true);
                transform.Rotate(transform.up * Time.deltaTime * -_rotationSpeed);
                _animationController.SetBool("TurnLeft", false);
            }
